    ...
    <footer className="bg-gray-900 text-gray-400 py-12">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-white font-bold mb-4">Pandrama</h3>
            <ul className="space-y-2">
              ...
              <li><Link to="/careers" className="hover:text-white transition">Empleo</Link></li>
              <li><Link to="/press" className="hover:text-white transition">Prensa</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link to="/support" className="hover:text-white transition">Centro de Ayuda</Link></li>
              <li><Link to="/faq" className="hover:text-white transition">Preguntas Frecuentes</Link></li>
              <li><Link to="/account" className="hover:text-white transition">Mi Cuenta</Link></li>
              <li><Link to="/devices" className="hover:text-white transition">Dispositivos Compatibles</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/privacy" className="hover:text-white transition">Política de Privacidad</Link></li>
              <li><Link to="/cookies" className="hover:text-white transition">Política de Cookies</Link></li>
              <li><Link to="/legal" className="hover:text-white transition">Información Legal</Link></li>
            </ul>
          </div>
        ...
        <div className="mt-12 pt-8 border-t border-gray-800 text-center">
          <p>&copy; {new Date().getFullYear()} Pandrama. Todos los derechos reservados.</p>
        </div>
      </div>
    </footer>
  );
