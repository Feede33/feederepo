        ...
        <div className="container mx-auto px-4 md:px-12">
          <div className="flex flex-col md:flex-row items-center md:items-start gap-6">
            ...
            <div className="text-center md:text-left">
              ...
              <p className="text-white/80">{profileData?.bio || 'Gestiona tus favoritos, lista de seguimiento y más'}</p>
              {profileData?.location && (
                <div className="flex items-center justify-center md:justify-start mt-2 text-sm text-white/70">
